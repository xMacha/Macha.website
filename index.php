...
<body>
  ...
  <div id="media-permission-overlay">
    Kliknij, aby aktywować odtwarzanie wideo i dźwięku
  </div>
  ...
  <div class="container">
    ...
    <main>
      ...
      <section id="about">
        ...
        <div id="buttons">
          <button onclick="window.open('https://kekma.net', '_blank')">Email</button>
          <button onclick="window.open('https://kekma.net', '_blank')">GitHub</button>
          <button onclick="window.open('https://kekma.net', '_blank')">YouTube</button>
          <button onclick="window.open('https://kekma.net', '_blank')">Steam</button>
          <button onclick="window.open('https://kekma.net', '_blank')">Roblox</button>
        </div>
      </section>
